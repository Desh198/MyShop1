...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckOutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "deshalin96@gmail.com", ZipCode="4019" });

            IPrincipal FakeUser =new GenericPrincipal(new GenericIdentity("deshalin96@gmail.com","Forms"),null);
